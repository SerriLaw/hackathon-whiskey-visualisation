...
const Footer = props =>
	<Modal isOpen={props.show} style={customStyles}>
		...
		<p className="data data-type">
			Type: {props.whiskey.type}
		</p>
		...
		<div className="colorLine">
			...
			<p className="data-colour">
				{props.whiskey.colour}
			</p>
		</div>
